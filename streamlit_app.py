...
# ─── CEK LOGOUT FLAG — sebelum cookies diinit ────────────────────────────────
# logout() di auth.py set st.session_state["just_logged_out"] = True
# lalu switch_page ke sini. session_state PERSIST antar switch_page.
...
# Sampai sini = tampilkan form login
